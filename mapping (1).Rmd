...
#How can we make an interactive map
```
...
Clipping pipelines takes a looooooong time
```{r}
...
From the raster of PAHs, is there actually big difference between near and far field?
